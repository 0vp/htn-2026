...
import { JOINT_LIMITS, control, mixDrive, setJoint, setWinch, useControl, type Joint } from './store';
...
export function ControllerPad(props: { link: CommandLink; telemetry: Telemetry | null }) {
  ...
  return (
    <div className="hairline border bg-paper">
      ...
      <div className="grid gap-px bg-ink/15 lg:grid-cols-[1.1fr_1fr_1fr]">
        {/* Drive */}
        <div className="bg-paper p-5">
          <p className="label text-ink/55">Drive · BTS7960 ×2</p>
          <div className="mt-4 flex gap-4">
            <div className="max-w-56 flex-1">
              <Stick x={s.stick.x} y={s.stick.y} disabled={s.estop} />
            </div>
